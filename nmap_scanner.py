...
======================================
 TEAM BD CYBER NINJA  - Advanced Nmap Scanner
======================================
Developed by: ZEROX UCHIHA FROM TEAM BD CYBER NINJA SPY AGENTS
""" + RESET)

    print(f"{RED}WARNING: Unauthorized scanning Black-Hat. Use responsibly and only with permission.{RESET}")
